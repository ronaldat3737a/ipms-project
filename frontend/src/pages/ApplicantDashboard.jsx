...
import { 
  LayoutDashboard, FileText, Bookmark, PenTool, FileStack, 
  LogOut, Bell, Search, Plus, CreditCard, AlertCircle, MoreHorizontal 
} from "lucide-react";

const ApplicantDashboard = () => {
  // Dữ liệu giả lập danh sách hồ sơ
  const recentApplications = [
    { id: "PT-2023-1234", type: "Sáng chế", name: "Hệ thống năng lượng tái tạo thông minh", date: "15/11/2023", status: "Đang thẩm định nội dung", color: "bg-cyan-100 text-cyan-600" },
    { id: "TM-2024-0012", type: "Nhãn hiệu", name: 'Logo "EcoLiving"', date: "20/01/2024", status: "Mới", color: "bg-gray-100 text-gray-500" },
    { id: "DS-2023-0567", type: "Kiểu dáng", name: "Thiết kế ghế văn phòng ergonomic", date: "01/12/2023", status: "Chờ sửa đổi", color: "bg-orange-100 text-orange-600" },
    { id: "PT-2022-8901", type: "Sáng chế", name: "Phương pháp xử lý nước thải tiên tiến", date: "10/09/2022", status: "Đã cấp văn bằng", color: "bg-green-100 text-green-600" },
    { id: "TM-2023-0345", type: "Nhãn hiệu", name: 'Tên sản phẩm "FutureTech"', date: "22/07/2023", status: "Chờ nộp lệ phí", color: "bg-purple-100 text-purple-600" },
    { id: "DS-2024-0005", type: "Kiểu dáng", name: "Bao bì sản phẩm thân thiện môi trường", date: "10/02/2024", status: "Đang thẩm định hình thức", color: "bg-blue-100 text-blue-600" },
    { id: "PT-2023-0099", type: "Sáng chế", name: "Thuật toán tối ưu hóa giao thông", date: "05/05/2023", status: "Từ chối", color: "bg-red-100 text-red-600" },
  ];
      ...
      <main className="flex-grow flex flex-col overflow-hidden">
        ...
        <header className="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-8 shrink-0">
          <div className="relative w-96">
            ...
            <input 
              type="text" placeholder="Tìm kiếm hồ sơ..." 
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 border-l pl-6 border-gray-100">
              ...
              <img 
                ...
                alt="Avatar" className="w-10 h-10 rounded-full bg-blue-100 border border-gray-200"
              />
            </div>
          </div>
        </header>
        ...
        <div className="p-8 space-y-8 overflow-y-auto">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
              <StatCard label="Tổng số đơn" value="1,250" icon={<FileText className="text-blue-500"/>} />
              <StatCard label="Đang xử lý" value="85" icon={<AlertCircle className="text-amber-500"/>} />
              <StatCard label="Cần bổ sung/Sửa đổi" value="12" icon={<PenTool className="text-red-500"/>} />
              <StatCard label="Đã cấp bằng" value="780" icon={<Bookmark className="text-green-500"/>} />
            </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              <ReminderItem 
                ...
                btnLabel="Thanh toán" btnColor="bg-pink-500 hover:bg-pink-600"
              />
              <ReminderItem 
                ...
                btnLabel="Sửa đổi hồ sơ" btnColor="bg-blue-500 hover:bg-blue-600"
              />
            </div>
          </section>
          ...
          <section className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-gray-50 text-gray-400 text-xs uppercase tracking-wider">
                    ...
                    <th className="px-6 py-4 font-bold text-center">Đối tượng</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {recentApplications.map((app, idx) => (
                    <tr key={idx} className="hover:bg-gray-50 transition">
                      <td className="px-6 py-4 text-sm font-bold text-blue-500">{app.id}</td>
                      <td className="px-6 py-4 text-center">
                        <span className="p-2 bg-gray-100 rounded-lg inline-block text-gray-500"><FileText size={16}/></span>
                      </td>
                      <td className="px-6 py-4 text-sm text-gray-700 font-medium">{app.name}</td>
            ...
            <div className="p-6 bg-gray-50 flex justify-between items-center text-xs text-gray-400">
              ...
              <div className="flex gap-2">
                <button className="p-2 border rounded-lg bg-white">Trước</button>
                <button className="p-2 border rounded-lg bg-blue-500 text-white px-3">1</button>
...
const NavItem = ({ icon, label, active = false }) => (
  <div className={`flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer transition-all ${active ? "bg-blue-50 text-blue-600" : "text-gray-500 hover:bg-gray-50"}`}>
    {icon}
  ...
  <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex items-center justify-between">
    <div className="flex items-center gap-5">
      ...
      <div>
        ...
        {amount && <p className="text-sm font-bold text-gray-800 mt-1">Số tiền: {amount}</p>}
      </div>
    </div>
    <button className={`${btnColor} text-white px-6 py-2.5 rounded-xl font-bold text-sm transition shadow-sm shrink-0 ml-4`}>
      {btnLabel}
    </button>
  </div>
);
