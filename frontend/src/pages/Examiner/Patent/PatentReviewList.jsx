...
const PatentReviewList = () => {
  ...
  // Dữ liệu mẫu khớp 100% với ảnh bạn gửi
  const MOCK_DATA = [
    { id: "1-2025-00001", times: 1, status: "Chờ sửa hình thức", date: "2025-01-15", owner: "Nguyễn Văn A" },
    { id: "1-2025-00002", times: 1, status: "Đang sửa hình thức", date: "2025-01-18", owner: "Trần Thị B" },
    { id: "1-2025-00007", times: 1, status: "Chờ sửa hình thức", date: "2025-02-01", owner: "Đặng Văn H" },
  ];
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden font-sans text-slate-900">
      ...
      {/* --- MAIN CONTENT: GIAO DIỆN GIỐNG 100% ẢNH --- */}
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <section className="flex-1 overflow-y-auto p-8 space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-500 font-medium">Quản lý các đơn đăng ký sáng chế theo trạng thái thẩm định.</p>
          </div>
          ...
          <div className="flex gap-4 items-center">
            <div className="relative flex-1 max-w-md">
              ...
              <input type="text" placeholder="Tìm kiếm theo mã đơn, tên người nộp..." className="w-full pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500/20" />
            </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b">
              ...
              <p className="text-xs text-slate-500 font-medium mt-1">Tổng cộng {MOCK_DATA.length} đơn đăng ký</p>
            </div>
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-slate-100">
                {MOCK_DATA.map((item) => (
                  <tr key={item.id} className="hover:bg-blue-50/30 transition-all cursor-pointer" onClick={() => navigate(`/examiner/review/sang-che/${item.id}`)}>
