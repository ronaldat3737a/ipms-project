...
const PatentFiling = () => {
  ...
  // 1. Quản lý bước hiện tại (Mặc định là bước 1)
          ...
          <div className="space-y-6">
            {steps.map((step) => (
              <div key={step.id} className="flex items-center gap-4 relative">
                {/* Vòng tròn số: Xanh nếu là bước hiện tại, Xám nếu chưa tới */}
                ...
                {/* Nhãn chữ: Xanh nếu là bước hiện tại */}
          ...
          <div className="max-w-4xl">
            ...
            <div className="space-y-10">
              ...
              <section className="space-y-3">
               ...
               {/* Ô bên phải: Chọn nhóm cơ bản (Sản phẩm/Quy trình) */}
